...
class Solution
{
    ...
    {
        // ab - cd
        bool s1 = IsSame(dots[0,0], dots[0,1], dots[1,0], dots[1,1], dots[2,0], dots[2,1], dots[3,0], dots[3,1]);
        // ac - bd
        bool s2 = IsSame(dots[0,0], dots[0,1], dots[2,0], dots[2,1], dots[1,0], dots[1,1], dots[3,0], dots[3,1]);
        // ad - bc
        bool s3 = IsSame(dots[0,0], dots[0,1], dots[3,0], dots[3,1], dots[1,0], dots[1,1], dots[2,0], dots[2,1]);
        return (s1 || s2 || s3) ? 1 : 0;
    }

    bool IsSame(double ax, double ay, double bx, double by,
